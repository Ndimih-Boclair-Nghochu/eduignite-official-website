...
import { DATA_PERIODS, ADMIN_CLASS_SUMMARY, ADMIN_GOVERNANCE_LOGS } from "./dashboard-mock-data";
            ...
            <TableBody>
              {ADMIN_CLASS_SUMMARY.map((cls, i) => (
                <TableRow key={i} className="hover:bg-primary/5 transition-colors border-b last:border-0 h-16">
                  ...
                  <TableCell className="text-center font-bold text-sm">{cls.attendance}%</TableCell>
