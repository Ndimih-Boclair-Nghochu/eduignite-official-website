# Generated by Django 4.2.11 on 2026-04-07 23:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['school', 'status'], name='live_classe_school__b04e88_idx'),
        ),
        migrations.AddIndex(
            model_name='liveclass',
            index=models.Index(fields=['teacher', 'start_time'], name='live_classe_teacher_dd132e_idx'),
        ),
        migrations.AddIndex(
            model_name='liveclass',
            index=models.Index(fields=['target_class', 'start_time'], name='live_classe_target__ad000d_idx'),
        ),
    ]
